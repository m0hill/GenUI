...
3. [Capabilities And Permissions](03-capabilities-and-permissions.md) explains capability grants, effects, policies, approvals, and how to adapt existing agent tools.
